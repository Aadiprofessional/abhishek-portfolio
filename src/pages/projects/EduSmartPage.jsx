...
const EduSmartPage = () => {
  ...
  const project = projects.find(p => p.id === 'edusmart')
            ...
            <div className="flex flex-wrap justify-center gap-4 mb-8">
              <div className="flex items-center gap-2 glass px-4 py-2 rounded-full">
                <div className={`w-3 h-3 rounded-full ${
                  project.status === 'Live' ? 'bg-green-400 animate-pulse' : 'bg-blue-400'
                }`} />
      ...
      <section className="relative py-32 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-400 max-w-3xl mx-auto">
              Revolutionary educational tools designed to enhance learning through AI and interactive 3D experiences.
            </p>
          </motion.div>
            ...
            {project.features.map((feature, index) => (
              ...
              >
                <div className="flex items-center gap-4 mb-4">
                  ...
                  >
                    <FontAwesomeIcon icon={faGraduationCap} style={{ color: project.primaryColor }} />
                  </div>
                  <h3 className="text-lg font-bold text-white group-hover:text-blue-400 transition-colors">
                    {feature}
                  </h3>
                </div>
                <div className="w-full h-1 bg-gradient-to-r from-green-500 to-blue-500 rounded-full opacity-30 group-hover:opacity-60 transition-opacity duration-300" />
              </motion.div>
            ))}
          </motion.div>
        </div>
      ...
      <section className="relative py-32 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-400 max-w-3xl mx-auto">
              Built with modern web technologies and 3D graphics to create immersive learning experiences.
            </p>
          </motion.div>
      ...
      <section className="relative py-32 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-400 max-w-3xl mx-auto">
              Key challenges in educational technology and innovative solutions that transformed learning.
            </p>
          </motion.div>
          ...
          >
            <div className="mb-8">
              ...
              <p className="text-xl text-gray-400 mb-8 max-w-2xl mx-auto">
                Join thousands of students and educators who are revolutionizing learning with AI-powered 
                interactive education. Start your learning journey today.
              </p>
              ...
              <div className="flex items-center justify-center gap-8 text-sm text-gray-400">
                <div className="flex items-center gap-2">
                  ...
                  <span>{project.metrics.students} students</span>
                </div>
                <div className="flex items-center gap-2">
                  <FontAwesomeIcon icon={faGraduationCap} className="text-blue-400" />
                  <span>{project.metrics.teachers} teachers</span>
                </div>
                <div className="flex items-center gap-2">
          ...
          <div className="flex justify-between items-center">
            ...
            <Link to="/contact" className="group">
              <motion.button
                whileHover={{ scale: 1.05, x: 4 }}
                whileTap={{ scale: 0.95 }}
                className="flex items-center gap-3 px-6 py-3 bg-gradient-to-r from-green-500 to-blue-600 text-white rounded-2xl font-semibold hover:shadow-lg transition-all duration-300"
              >
                Discuss Education Projects
