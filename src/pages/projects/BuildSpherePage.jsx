...
const BuildSpherePage = () => {
  const containerRef = useRef(null)
  const { scrollYProgress } = useScroll({ target: containerRef })
  const y = useTransform(scrollYProgress, [0, 1], ['0%', '50%'])
  
  const project = projects.find(p => p.id === 'buildsphere')
            ...
            <div className="flex flex-wrap justify-center gap-4 mb-8">
              <div className="flex items-center gap-2 glass px-4 py-2 rounded-full">
                <div className={`w-3 h-3 rounded-full ${
                  project.status === 'Enterprise' ? 'bg-orange-400 animate-pulse' : 'bg-blue-400'
                }`} />
      ...
      <section className="relative py-32 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-400 max-w-3xl mx-auto">
              Revolutionary construction management tools with digital twins, IoT integration, and predictive analytics.
            </p>
          </motion.div>
            ...
            {project.features.map((feature, index) => (
              ...
              >
                <div className="flex items-center gap-4 mb-4">
                  ...
                  >
                    <FontAwesomeIcon icon={faHardHat} style={{ color: project.primaryColor }} />
                  </div>
                  <h3 className="text-lg font-bold text-white group-hover:text-blue-400 transition-colors">
                    {feature}
                  </h3>
                </div>
                <div className="w-full h-1 bg-gradient-to-r from-red-500 to-orange-500 rounded-full opacity-30 group-hover:opacity-60 transition-opacity duration-300" />
              </motion.div>
            ))}
          </motion.div>
        </div>
      ...
      <section className="relative py-32 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-400 max-w-3xl mx-auto">
              Built with enterprise-grade technologies for scalability, security, and real-time data processing.
            </p>
          </motion.div>
            ...
            {project.technologies.map((tech, index) => (
              ...
              >
                <div className="text-2xl mb-3 group-hover:scale-110 transition-transform duration-300">
                  <FontAwesomeIcon icon={faCode} className="text-red-400" />
                </div>
      ...
      <section className="relative py-32 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-400 max-w-3xl mx-auto">
              Complex construction industry challenges solved with innovative technology and smart engineering.
            </p>
          </motion.div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <div className="mb-8">
              ...
              >
                <FontAwesomeIcon icon={faIndustry} className="text-3xl text-white" />
              </div>
              <h3 className="text-3xl md:text-4xl font-bold text-white mb-4">
                Enterprise {project.title}
              </h3>
              <p className="text-xl text-gray-400 mb-8 max-w-2xl mx-auto">
                Transform your construction projects with digital twins, IoT monitoring, and AI-powered analytics. 
                Join leading construction companies revolutionizing project management.
              </p>
              ...
              <div className="flex items-center justify-center gap-8 text-sm text-gray-400">
                <div className="flex items-center gap-2">
                  ...
                  <span>{project.metrics.projects} projects</span>
                </div>
                <div className="flex items-center gap-2">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span>{project.metrics.savings} cost savings</span>
                </div>
              </div>
            </div>
          </motion.div>
          ...
          <div className="flex justify-between items-center">
            ...
            <Link to="/contact" className="group">
              <motion.button
                whileHover={{ scale: 1.05, x: 4 }}
                whileTap={{ scale: 0.95 }}
                className="flex items-center gap-3 px-6 py-3 bg-gradient-to-r from-red-500 to-orange-600 text-white rounded-2xl font-semibold hover:shadow-lg transition-all duration-300"
              >
...
export default BuildSpherePage 